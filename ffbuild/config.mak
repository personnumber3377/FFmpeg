...
CC_IDENT=Ubuntu clang version 18.1.3 (1ubuntu1)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
CC=clang
...
CFLAGS= -fsanitize=address,undefined,fuzzer-no-link -fno-omit-frame-pointer -fsanitize=address   -std=c17 -fPIC    -pthread  -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/fribidi -DXML_STATIC -DFRIBIDI_LIB_STATIC  -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/opus -I/usr/include/opus       -I/usr/include/libxml2          -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -fsanitize=address,undefined,fuzzer-no-link -fsanitize=address  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avformat=-lm -latomic -lxml2 -licui18n -licuuc -licudata -lz -llzma -lm -lbz2 -lz
EXTRALIBS-avcodec=-lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -pthread -lm -latomic -llzma -lfdk-aac -lm -lopus -lm -ltheoraenc -ltheoradec -logg -lvorbis -lm -logg -lvorbisenc -lvorbis -lm -logg -lz -lva
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lva-drm -lva -lva-x11 -lva -lvdpau -lX11 -lm -lva -latomic -pthread -lX11 -lpthread -lxcb -lXau -lXdmcp
EXTRALIBS-ffplay=-lSDL2 -lm -lasound -lm -ldl -lpthread -lpulse -pthread -lsamplerate -lX11 -lXext -lXcursor -lXi -lXfixes -lXrandr -lXss -ldrm -lgbm -lwayland-egl -lwayland-client -lwayland-cursor -lxkbcommon -ldecor-0 -lpthread
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
